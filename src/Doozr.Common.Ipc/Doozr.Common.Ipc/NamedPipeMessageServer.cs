...
{
	[Log]
	public class NamedPipeMessageServer: INamedPipeMessageServer, ILoggingObject
	{
		...
		public delegate INamedPipeMessageServer Factory(string pipeName, int maxNumberOfInstances, int initialNumberOfInstances);
