...
C:\projects\doozr-common\build\scripts\..\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:C:\projects\doozr-common\build\scripts\run_tests.cmd -filter:"+[Doozr.*]* -[*.Tests]*" -register:user -searchdirs:C:\projects\doozr-common\src\Doozr.Common.Utilities\Doozr.Common.Utilities.Tests\bin\Debug -output:C:\projects\doozr-common\build\scripts\..\coverage\results.xml
